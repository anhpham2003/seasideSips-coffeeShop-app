...
if __name__ == "__main__":
    recommendation_agent = RecommendationAgent(
        sys.path.append(os.path.join(folder_path, "recommendation_objects/apriori_recommendation.json")),
        sys.path.append(os.path.join(folder_path, "recommendation_objects/popularity_recommendation.csv")),
        "recommendation_objects/apriori_recommendation.json",
        "recommendation_objects/popularity_recommendation.csv"
    )

print(recommendationAgent.get_popular_recommendation())
